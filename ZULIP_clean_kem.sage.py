...
# This file was *autogenerated* from the file ZULIP_clean_kem.sage
from sage.all_cmdline import *   # import sage library

_sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_0p999999999999999 = RealNumber('0.999999999999999'); _sage_const_4 = Integer(4); _sage_const_0p000000001 = RealNumber('0.000000001')
...
MS_ZZ_c = MatrixSpace(ZZ, _sage_const_1 , ndim)
MS_ZZ_c_transposed = MatrixSpace(ZZ, ndim, _sage_const_1 )
MS_QQ = MatrixSpace(QQ, ndim, ndim)
MS_QQ_c = MatrixSpace(QQ, _sage_const_1 , ndim)
...
def main():
    ...
    rho = _sage_const_0p999999999999999  #0.99 #has to be less than 1 because we're working in Zn??? not sure (shortest vector has norm 1), no clue if this is a good value
    q = ceil((s * ndim / rho) * sqrt(log(_sage_const_2 *ndim + _sage_const_4 )/pi)) #from Ducas' KEM TODO: delete q * 100000 from sampler line, just for DEBUG
...
#        return hash_obj.hexdigest()
    ...
    def quadratic_norm(x, Q):
        ...
        return sqrt((x.transpose() * Q * x)[_sage_const_0 ][_sage_const_0 ])
...
#        restart_program()
    ...
    def begin_decaps():
        ...
        c_minus_Uy_list = [_sage_const_0 ] * ndim
        threshold = _sage_const_0p000000001 
        for i in range(ndim):
            if(c_minus_Uy[_sage_const_0 , i] < threshold and c_minus_Uy[_sage_const_0 , i] > - threshold):
                c_minus_Uy[_sage_const_0 , i] = _sage_const_0 
            while(c_minus_Uy[_sage_const_0 , i] < _sage_const_0 ):
                c_minus_Uy[_sage_const_0 , i] = c_minus_Uy[_sage_const_0 , i] + _sage_const_1 
            c_minus_Uy_list[i] = c_minus_Uy[_sage_const_0 , i]
