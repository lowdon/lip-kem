...
_sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_75 = Integer(75); _sage_const_0p475 = RealNumber('0.475'); _sage_const_100 = Integer(100); _sage_const_2 = Integer(2); _sage_const_4 = Integer(4)
...
if(len(sys.argv[_sage_const_1 :]) == _sage_const_0 ):
    ndim = _sage_const_75 
else:
    ndim = int(sys.argv[_sage_const_1 ])
print("lattice dimensions (ndim): ", ndim)

rho = _sage_const_0p475  # rho < lambda_1(S)/2 = 1/2
print("PARAMS:\nrho: ", rho)
...
s = _sage_const_100 *rho/sqrt(ndim)#2**(ndim) # Choose a positive real value # from corollary 3.3 HuckBennett's paper on rotations of Zn
print("s: ", s)
...
def main():
    ...
    def discrete_n_dim_sampler():
        ...
        initial_basis = [_sage_const_0 ] * ndim


        for i in range(ndim):
            ivec = [_sage_const_0 ] * ndim
            for k in range(ndim):
                ivec[k] = sampler()
